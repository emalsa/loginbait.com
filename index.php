...
<body class="antialiased bg-body text-body font-body">
    <div class="">
          ...
          <div class="flex flex-wrap -m-6 mb-24">
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
                ...
                <p class="text-base text-black">We believe that on the Internet there should be the possibility to use a service for free, even if it is restricted. However, in this case we decided against it.The reason for this is that we do not want to put the bait website too much in the public. If this website is too widely known, the risk would increase that the attacker would not log in to the website at all. </p>
              </div>
            </div>
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
            ...
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
                ...
                <p class="text-base text-black">You can easily test this. After you have received the credentials and the URL via Email, you can click on the login button on the website and you will receive an alert mail.</p>
              </div>
            </div>
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
                <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900">Will the service continue once someone has logged in?</h2>
                <p class="text-base text-black">Yes, the service will continue. You don't have to worry about it. We limit email alerts to 10 emails per month. So if the attacker/thief tries to log in several times, you won't get more than 10 emails in that month. The next month you will simply have a quota of 10 emails again.</p>
              </div>
            </div>
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
      ...
      In addition, we will refund the money if we have demonstrably failed to notify you of a login.</p>
            ...
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
                ...
                <p class="text-base text-black">Unfortunately, we are not allowed to and cannot do that. The point is that you will be notified as soon as someone has viewed your data and credentials that he should not. So you can react fast and change passwords if necessary. You get in the alert email some data (IP, browser etc.) from the login attempt. Possibly the authorities can work with it further when you forward the information.</p>
              </div>
            </div>
          </div>
      ...
      <section class="pt-28 pb-40 bg-gray-50 overflow-hidden"><div class="container mx-auto px-4">
            ...
            <div class="w-full md:w-1/2 p-6">
              <div class="md:max-w-xl">
                <div class="mb-5 p-1 flex flex-col md:flex-row bg-white overflow-hidden focus-within:ring-4 focus-within:ring-indigo-500 border border-gray-200 rounded-10">
                  <input class="w-full flex-1 px-5 py-3.5 text-base text-gray-500 bg-transparent outline-none placeholder-gray-500 rounded-tl-md rounded-bl-md" type="text" placeholder="Your email address">
      ...
      <section class="pt-24 overflow-hidden">
        <div class="container mx-auto px-4">
          <img class="mx-auto mb-16" src="gradia-assets/logos/gradia-name-black.svg" alt="">
